...
//    override init() {
//        super.init()
//        NotificationCenter.defaultCenter().addObserver(self, selector: #selector(UITextFieldHelper.textFieldViewDidChange(_:)), name: UITextFieldTextDidChangeNotification, object: nil)
//    }
//    
...
//                        textField.text = (text as NSString).substring(with: NSMakeRange(0, limit))
...
////                tvPlaceholderLabel.isHidden = (self.text > 0)
//            } else {
//                self.addtvPlaceholderLabel(tvPlaceholderText: newValue!)
//            }
//        }
//    }
//    
...
//        tvPlaceholderLabel.textColor = UIColor.lightGray
...
//    override init() {
//        super.init()
//        NotificationCenter.default.addObserver(self, selector: #selector(UITextViewDelegate.textViewDidChange(_:)), name: NSNotification.Name.UITextViewTextDidChange, object: nil)
//    }
//    
...
//                    if (text as NSString).length >= limit {
//                        textView.text = (text as NSString).substring(with: NSMakeRange(0, limit))
//                    }
//                }
//            }
//            
