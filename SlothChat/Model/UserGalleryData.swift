...
class UserGalleryData : NSObject, NSCoding, Mappable{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         list = aDecoder.decodeObject(forKey: "list") as? [UserGalleryPhoto]
